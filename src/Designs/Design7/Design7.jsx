...
import styles from "./Design7.module.css";
    ...
    <div className={styles.container}>
      ...
      >
            ...
            return (
              <div className={styles.exp} key={key}>
                ...
                <div className={styles.expDetail}>
                  ...
                  <div className={styles.pos}>{experienceDetail.jobTitle}</div>
        ...
        <div className={styles.sk}>
          ...
          >
            <option className={styles.check} value="PROJECTS" name="PROJECTS">
              PROJECTS
            </option>
            <option className={styles.check} value="AWARDS" name="AWARDS">
              AWARDS
            </option>
            <option className={styles.check} value="EDUCATION" name="EDUCATION">
              EDUCATION
            </option>
          </select>
